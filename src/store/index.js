let productList = [
  {
    ...
    productPrice: 1100,
    productDescription: "Telmikind 40 tablet is used in conditions like heart failure and high blood pressure.",
  },
  {
    productId: 2,
    productName: "Cilacar 10",
    productPrice:900,
    productDescription: "Cilacar 10 MG Tablet is a composition of Cilnidipine, which falls into the Calcium Channel Blockers category.",
  },
  {
    productId: 3,
    productName: "Relife",
    productPrice: 200,
    productDescription: "Relife Tablet is an over-the-counter pain reliever and fever reducer.",
  },
  {
    productId: 4,
    productName: "Combiflam 400/325 MG",
    productPrice: 300,
    productDescription: "Combiflam Tablet reduces Pain, fever, and inflammation together.",
  },
  {
    productId: 5,
    productName: "Vitamin A",
    productPrice: 450,
    productDescription: "To Increase intake of Vitamin A, used in Vitamin A deficiency.",
  },
  {
    productId: 6,
    productName: "Vitamin C",
    productPrice: 500,
    productDescription: "To Increase intake of Vitamin C, used in Vitamin C deficiency.",
  },
  {
    productId: 7,
    productName: "Vitamin E",
    productPrice: 650,
    productDescription: "To Increase intake of Vitamin E, used in Vitamin E deficiency.",
  },
  {
    productId: 8,
    productName: "Calcium Capsules",
    productPrice: 200,
    productDescription: "To Increase intake of Calcium, used in increasing Bone Density.",
  },
];
let distributorList = [
  {
...
export const addToCart = (productId, quantity) => {
  const cartItem = {
    quantity: quantity, ...productList[productId - 1],
...
export const grandTotalAmount = () => {return grandTotal;}